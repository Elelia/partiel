 ...
 */
class LoupgarouRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, Loupgarou::class);
    }

    public function save(Loupgarou $entity, bool $flush = false): void
    {
    ...
    public function remove(Loupgarou $entity, bool $flush = false): void
    {
